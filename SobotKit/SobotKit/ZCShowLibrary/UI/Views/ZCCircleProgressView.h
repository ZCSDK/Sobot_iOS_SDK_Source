...
@interface ZCCircleProgressView : UIView <CAAnimationDelegate>
 ...
 */
@property (nonatomic, copy) void (^fillChangedBlock)(ZCCircleProgressView *progressView, BOOL filled, BOOL animated);
 ...
 *  Example usage would be to invert the colors on your centralView
 */
@property (nonatomic, copy) void (^didSelectBlock)(ZCCircleProgressView *progressView);
 ...
 */
@property (nonatomic, copy) void (^progressChangedBlock)(ZCCircleProgressView *progressView, CGFloat progress);
 ...
 */
@property (nonatomic, copy) void (^didLongPressBlock)(ZCCircleProgressView *progressView);
